...
tenses = {
  ...
  "subjunctive future"  => ["if I were to arise", "if I should arise", "if they shouldn't arise"],
  "going to-future"     => ["they are going to cry", "they're going to cry", "are going to cry", "he is going to cry"],
  ...
  "conditional simple"      => ["I would arise" ,"I wouldn't arise"],
